...
export default function Profile() {
  ...
  for (let i = 0; i < numCols; i++) {
    ...
    const end = Math.min(
      (i + 1) * Math.ceil(rows.length / numCols),
      rows.length,
    );
    const col = (
  ...
  return (
    <>
      <a
        href="#"
        className="w-full m-10 bg-white border border-gray-200 rounded-lg shadow"
      >
        <div className="flex flex-row">
          <div className="w-1/2">
            ...
            <div className="flex-auto ml-8">
              <h3 className="w-1/2 mb-4 font-semibold text-gray-900 dark:text-white">
                하루에 받을 문제 수
              </h3>
        ...
        <div className="flex justify-center">
          <h3 className="mt-10 font-semibold text-gray-900 dark:text-white">
            오늘의 문제
          </h3>
        </div>
